...
$router->post('/order/delete/', [\App\Controller\OrderController::class, 'deleteAction']);
...
$router->post('/pick-point/delete/', [\App\Controller\PickPointController::class, 'deleteAction']);
...
$router->post('/product/delete/', [\App\Controller\ProductController::class, 'deleteAction']);
...
$router->post('/stock/delete/', [\App\Controller\StockController::class, 'deleteAction']);
...
$router->post('/user/delete/', [\App\Controller\UserController::class, 'deleteAction']);
...
$router->post('/product-section/delete/', [\App\Controller\SectionController::class, 'deleteAction']);
